...
user in an INI file next to Notepad++Portable.exe called Notepad++Portable.ini.
...
copy AppNamePortable.ini from this directory to Notepad++Portable.ini next to
Notepad++Portable.exe. The options in the INI file are as follows:
